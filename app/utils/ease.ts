...
export function easing(n:number, ease:Easing):number{
    switch(ease){
        ...
        case 'easeInElastic': return easeInElastic(n)
        case 'easeOutElastic': return easeOutElastic(n)
        case 'easeInOutElastic': return easeInOutElastic(n)
        case 'easeInBounce': return easeInBounce(n)
        case 'easeOutBounce': return easeOutBounce(n)
        case 'easeInOutBounce': return easeInOutBounce(n)
        default: return n
    }
}